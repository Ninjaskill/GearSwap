...
function init_gear_sets()
        ...
        sets.MND = {
        	...
        	head="Hlr. Cap +1",neck="Ajari Necklace",ear1="Star Earring",ear2="Star Earring",
		...
		-- Midcast sets
        sets.midcast['Healing Magic'] = set_combine(sets.MND,{neck="Fylgja Torque +1",ear1="Novia Earring",ear2="Roundel Earring",body="Aristocrat's Coat",hands="Hlr. Mitts +1",legs="Bls. Trousers +1"})
		...
		-- Resting sets
		sets.resting = {
			main="Mjollnir",sub="Legion Scutum",
